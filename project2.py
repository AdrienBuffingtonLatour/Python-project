# Use arrows on the keyboard to move player and space bar to shoot a missile #
...
class Enemy(Spaceship):
    ...
    def collision_border(self):
        if abs(self.xcor()) > 295 or abs(self.ycor()) > 295:
            self.hideturtle()
            self.up()
...
class Score(turtle.Turtle):
    ...
    def show_score(self):
        ...
        self.color("white")
        self.write("Score: {}".format(self.score), False, align="center",
...
class Lives(turtle.Turtle):
    ...
    def show_lives(self):
        ...
        self.color("white")
        self.write("Lives: {}".format(self.lives), False, align="center",
                    font=("Arial", 11, "normal"))
...
# Create multiple enemies and stars

enemies = []
for i in range(15):
    enemies.append(Enemy("triangle", "red", random.randint(-290, 290), random.randint(-290, 290)))
